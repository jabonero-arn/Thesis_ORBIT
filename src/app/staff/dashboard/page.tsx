...
import { User, Package, PackageOpen, History as HistoryIcon, PlusCircle, Edit, Trash, CheckCircle, PackageCheck } from "lucide-react"
import {
  Card,
  CardContent,
  CardDescription,
...
import { ManagementSidebar, type StaffView } from "@/components/management-sidebar"
...
export default function StaffDashboardPage() {
    ...
    return (
        <div className="flex min-h-screen w-full bg-[#1e2430]">
            <ManagementSidebar role="Staff" activeView={activeView} onViewChange={setActiveView} />
            <div className="flex flex-1 flex-col">
                <header className="flex h-16 items-center justify-between p-4 border-b border-border/50 shadow-sm bg-[#1e2430]/80 backdrop-blur-sm sticky top-0 z-30">
                     <div className="flex items-center gap-4">
                        <Logo />
                        <h1 className="font-headline text-xl font-bold">Staff</h1>
                    </div>
                    <UserNav role="Staff">
