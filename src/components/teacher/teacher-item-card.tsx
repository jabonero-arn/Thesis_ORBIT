...
import { CheckCircle, Lock, Hourglass, Info, MapPin, Tags, Box } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { Button } from "@/components/ui/button"

type TeacherItemCardProps = {
  item: InventoryItem
  onSelect: () => void
  onDetail: () => void
  isSelected: boolean
...
export function TeacherItemCard({ 
    item, 
    onSelect, 
    onDetail,
    isSelected, 
    locationName 
}: TeacherItemCardProps) {
