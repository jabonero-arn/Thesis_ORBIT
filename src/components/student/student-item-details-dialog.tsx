...
import { MapPin, Tags, Info, Lock, CheckCircle, Hourglass, Box, ShoppingCart } from "lucide-react"
import { cn } from "@/lib/utils"

type StudentItemDetailsDialogProps = {
...
export function StudentItemDetailsDialog({
  item,
  open,
  onOpenChange,
  onBorrow,
                    ...
                    <div className="flex flex-col gap-3 pt-2">
                        <div className="flex items-center gap-3 text-sm text-white/90">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[10px] font-bold uppercase text-muted-foreground tracking-tight">Stored In</span>
                ...
                <div className="space-y-4">
                     <div className="p-4 rounded-xl bg-black/30 border border-border/50 space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col">
                                <span className="text-[10px] font-bold uppercase text-muted-foreground tracking-widest">Available Stock</span>
